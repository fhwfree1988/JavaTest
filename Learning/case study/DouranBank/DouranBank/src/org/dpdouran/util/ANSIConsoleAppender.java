...
public class ANSIConsoleAppender extends ConsoleAppender {
	...
	private static final String INFO_COLOUR = PREFIX + NORMAL + SEPARATOR + FOREGROUND_BLUE + SUFFIX;
	private static final String DEBUG_COLOUR = PREFIX + SEPARATOR + FOREGROUND_MAGENTA + SUFFIX;
